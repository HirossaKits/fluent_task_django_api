# Generated by Django 3.0.7 on 2021-09-14 13:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category_project', to='api.Project')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category', to='api.TaskCategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar_img', models.ImageField(blank=True, null=True, upload_to=api.models.upload_avatar_path)),
                ('desctiption', models.CharField(blank=True, max_length=250, null=True)),
